...
def get_pe_stats(tickers=None) -> pd.DataFrame:
    ...
    cols = [
        ...
        "pfcf_rolling_5yr_median", "normalized_pfcf_5y",
        "current_fcf_yield", "fcf_yield_3y_avg", "fcf_yield_5y_avg", "forward_pfcf",
...
def get_pe_history(tickers, start: str | None = None, end: str | None = None) -> pd.DataFrame:
    ...
    cols = [
        ...
        "ttm_fcf", "pfcf_ratio", "pfcf_rolling_5yr_median", "normalized_pfcf_5y",
        "fcf_yield", "fcf_yield_3y_avg", "fcf_yield_5y_avg",
        "ttm_ebitda", "ev_ebitda", "ev_ebitda_rolling_5yr_median", "normalized_evebitda_5y",
