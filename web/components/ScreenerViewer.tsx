...
const RANGE_FIELD_META: Record<string, { label: string; fmt: FmtType }> = {
  ...
  q1_rev_yoy:        { label: "Last Q Rev YoY",    fmt: "pct" },
  q1_earn_yoy:       { label: "Last Q Earn YoY",   fmt: "pct" },
  q1_ebit_yoy:       { label: "Last Q EBIT YoY",   fmt: "pct" },
  q2_rev_yoy:        { label: "Prior Q Rev YoY",   fmt: "pct" },
  q2_earn_yoy:       { label: "Prior Q Earn YoY",  fmt: "pct" },
  q2_ebit_yoy:       { label: "Prior Q EBIT YoY",  fmt: "pct" },
  accel_rev_yoy:     { label: "Rev Accel (pp)",    fmt: "pct" },
...
const FILTER_SECTIONS: { label: string; fields: string[] }[] = [
  ...
  { label: "Quarterly YoY",     fields: ["q1_rev_yoy", "q1_earn_yoy", "q1_ebit_yoy", "q2_rev_yoy", "q2_earn_yoy", "q2_ebit_yoy"] },
  { label: "Growth Acceleration", fields: ["accel_rev_yoy", "accel_earn_yoy", "accel_ebit_yoy", "op_leverage_q1"] },
...
const RESULT_COLS: { key: string; label: string; fmt: FmtType }[] = [
  ...
  { key: "q1_rev_yoy",               label: "Last Q Rev YoY",   fmt: "pct" },
  { key: "q1_earn_yoy",              label: "Last Q Earn YoY",  fmt: "pct" },
  { key: "q1_ebit_yoy",              label: "Last Q EBIT YoY",  fmt: "pct" },
  { key: "q2_rev_yoy",               label: "Prior Q Rev YoY",  fmt: "pct" },
  { key: "q2_earn_yoy",              label: "Prior Q Earn YoY", fmt: "pct" },
  { key: "q2_ebit_yoy",              label: "Prior Q EBIT YoY", fmt: "pct" },
  { key: "accel_rev_yoy",            label: "Rev Accel",       fmt: "pct" },
  { key: "accel_earn_yoy",           label: "Earn Accel",      fmt: "pct" },
  { key: "op_leverage_q1",           label: "Op Leverage",     fmt: "pct" },
...
const PRESETS: Record<string, Preset> = {
  ...
  growth_inflection: {
    ...
    filters: {
      market_cap_b_min: "0.3",
      q1_rev_yoy_min: "10",
      q2_rev_yoy_min: "0",
      q1_earn_yoy_min: "0",
      q2_earn_yoy_min: "0",
      accel_rev_yoy_min: "0",
      accel_earn_yoy_min: "0",
      op_leverage_q1_min: "0",
      debt_to_ebitda_max: "4",
      gross_margin_min: "25",
    },
    tooltip: [
      ["Mkt Cap",        "> $300M"],
      ["Rev/Earn YoY",   "already growing, now accelerating"],
      ["Op Leverage",    "EBIT growth > Rev growth"],
      ["Debt/EBITDA",    "< 4x"],
      ["Gross Margin",   "> 25%"],
    ],
  },
  turnaround_inflection: {
    label: "Turnaround Inflection",
    filters: {
      market_cap_b_min: "0.3",
      q1_rev_yoy_min: "5",
      q2_rev_yoy_max: "0",
    ...
    tooltip: [
      ["Mkt Cap",        "> $300M"],
      ["Rev YoY",        "prior Q negative, last Q positive"],
      ["Debt/EBITDA",    "< 3x"],
      ["Gross Margin",   "> 20%"],
    ],
  },
